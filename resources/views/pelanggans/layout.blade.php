        ...
        <div class="layout">
            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href="index.html">
                        <img src="{{ asset('/images/logo/logoUndira.png') }}" alt="Logo" style="max-width: 220px;">
                        <img class="logo-fold" src="{{ asset('/images/logo/logoUndira_Favicon.png') }}" alt="Logo" style="max-width:70px;">
                    </a>
                </div>
                <div class="logo logo-white">
                    <a href="index.html">
                        <img src="assets/images/logo/logoUndira_Favicon.png" alt="Logo" style="max-width: 220px;">
                        <img class="logo-fold" src="assets/images/logo/logoUndira.png" alt="Logo" style="max-width: 220px;">
                    </a>
                </div>
                <div class="nav-wrap">
                    <ul class="nav-left">
            ...
            <div class="side-nav">
                <div class="side-nav-inner">
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle" href="{{ route('barangs.index') }}">
                                <span class="icon-holder">
            ...
            <div class="page-container">
                ...
                <footer class="footer">
                    <div class="footer-content">
                        <p class="m-b-0">Copyright © 2022 411192094_Aditya Dwi Aprianto. All rights reserved.</p>
                        <span>
